...
## V10.2 — Gestion du dépôt

Cette version corrige les chemins d’import des nouvelles fonctions
Cloudflare Pages et affiche le numéro `V10.2` à côté du nom BreizhStops.
...
## V10.2 — résolution des conducteurs
...
## V10.2 — Conducteur via rollup Notion
...
## V10.2 — synchronisation par lots
...
## V10.2 — synchronisation complète par lots
...
## V10.2 — Accueil et identité visuelle
...
## V10.2 — ajustements visuels ciblés
...
## V10.2 — visuels et filtrage définitif
...
## V10.2 — Prise de poste et statistiques
...
Exécuter dans la console D1 tout le bloc V10.2 présent à la fin de `schema.sql`,
...
## V10.2 — Activité et progressions
...
## V10.2 — correction de l'emplacement du chronotachygraphe
...
## V10.2 — correction Stationnement
...
## V10.2 — schéma final et détection des véhicules
...
## V10.2 — synchronisation Notion par lots
...
## V10.2 — optimisation Stationnement et Départs
...
## V10.2 — proportions PC, paysage iPhone et compteurs
...
## V10.2 — Stationnement et tâches du jour
...
## V10.2 — correction des vues Notion
...
## V10.2 — nom des conducteurs corrigé
...
## V10.2 — synchronisation publique et heures locales
...
## V10.2 — stationnement public et compteur d'heures fidèle
...
## V10.2 — opérations BreizhStops sans reconnexion Cloudflare
