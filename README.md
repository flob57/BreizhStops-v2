...
## V7.2.1 — Gestion du dépôt

Cette version corrige les chemins d’import des nouvelles fonctions
Cloudflare Pages et affiche le numéro `V7.2.1` à côté du nom BreizhStops.
...
## V7.2.1 — résolution des conducteurs
...
## V7.2.1 — Conducteur via rollup Notion
...
## V7.2.1 — synchronisation par lots
...
## V7.2.1 — synchronisation complète par lots
...
## V7.2.1 — Accueil et identité visuelle
...
## V7.2.1 — ajustements visuels ciblés
...
## V7.2.1 — visuels et filtrage définitif
...
## V7.2.1 — Prise de poste et statistiques
...
Exécuter dans la console D1 tout le bloc V7.2.1 présent à la fin de `schema.sql`,
...
## V7.2.1 — Activité et progressions
...
## V7.2.1 — correction de l'emplacement du chronotachygraphe
...
## V7.2.1 — correction Stationnement
