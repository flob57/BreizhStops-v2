...
## V7.7 — Gestion du dépôt

Cette version corrige les chemins d’import des nouvelles fonctions
Cloudflare Pages et affiche le numéro `V7.7` à côté du nom BreizhStops.
...
## V7.7 — résolution des conducteurs
...
## V7.7 — Conducteur via rollup Notion
...
## V7.7 — synchronisation complète par lots
...
## V7.7 — Accueil et identité visuelle
...
## V7.7 — ajustements visuels ciblés
...
## V7.7 — visuels et filtrage définitif
...
## V7.7 — Prise de poste et statistiques
...
Exécuter dans la console D1 tout le bloc V7.7 présent à la fin de `schema.sql`,
...
## V7.7 — correction de l'emplacement du chronotachygraphe
...
## V7.7 — schéma final et détection des véhicules
...
## V7.7 — synchronisation Notion par lots
...
## V7.7 — optimisation Stationnement et Départs
...
## V7.7 — proportions PC, paysage iPhone et compteurs
...
## V7.7 — Stationnement et tâches du jour
...
## V7.7 — correction des vues Notion
