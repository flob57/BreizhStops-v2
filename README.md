...
## V7.4 — Gestion du dépôt

Cette version corrige les chemins d’import des nouvelles fonctions
Cloudflare Pages et affiche le numéro `V7.4` à côté du nom BreizhStops.
...
## V7.4 — résolution des conducteurs
...
## V7.4 — Conducteur via rollup Notion
...
## V7.4 — synchronisation complète par lots
...
## V7.4 — Accueil et identité visuelle
...
## V7.4 — ajustements visuels ciblés
...
## V7.4 — visuels et filtrage définitif
...
## V7.4 — Prise de poste et statistiques
...
Exécuter dans la console D1 tout le bloc V7.4 présent à la fin de `schema.sql`,
...
## V7.4 — correction de l'emplacement du chronotachygraphe
...
## V7.4 — schéma final et détection des véhicules
...
## V7.4 — synchronisation Notion par lots
...
## V7.4 — optimisation Stationnement et Départs
...
## V7.4 — proportions PC, paysage iPhone et compteurs
