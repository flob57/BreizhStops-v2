...
## V10.1 — Gestion du dépôt

Cette version corrige les chemins d’import des nouvelles fonctions
Cloudflare Pages et affiche le numéro `V10.1` à côté du nom BreizhStops.
...
## V10.1 — résolution des conducteurs
...
## V10.1 — Conducteur via rollup Notion
...
## V10.1 — synchronisation par lots
...
## V10.1 — synchronisation complète par lots
...
## V10.1 — Accueil et identité visuelle
...
## V10.1 — ajustements visuels ciblés
...
## V10.1 — visuels et filtrage définitif
...
## V10.1 — Prise de poste et statistiques
...
Exécuter dans la console D1 tout le bloc V10.1 présent à la fin de `schema.sql`,
...
## V10.1 — Activité et progressions
...
## V10.1 — correction de l'emplacement du chronotachygraphe
...
## V10.1 — correction Stationnement
...
## V10.1 — schéma final et détection des véhicules
...
## V10.1 — synchronisation Notion par lots
...
## V10.1 — optimisation Stationnement et Départs
...
## V10.1 — proportions PC, paysage iPhone et compteurs
...
## V10.1 — Stationnement et tâches du jour
...
## V10.1 — correction des vues Notion
...
## V10.1 — nom des conducteurs corrigé
...
## V10.1 — synchronisation publique et heures locales
...
## V10.1 — stationnement public et compteur d'heures fidèle
...
## V10.1 — opérations BreizhStops sans reconnexion Cloudflare
