...
## V7.2 — Gestion du dépôt

Cette version corrige les chemins d’import des nouvelles fonctions
Cloudflare Pages et affiche le numéro `V7.2` à côté du nom BreizhStops.
...
## V7.2 — résolution des conducteurs
...
## V7.2 — Conducteur via rollup Notion
...
## V7.2 — synchronisation complète par lots
...
## V7.2 — Accueil et identité visuelle
...
## V7.2 — ajustements visuels ciblés
...
## V7.2 — visuels et filtrage définitif
...
## V7.2 — Prise de poste et statistiques
...
Exécuter dans la console D1 tout le bloc V7.2 présent à la fin de `schema.sql`,
...
## V7.2 — correction de l'emplacement du chronotachygraphe
