...
## V10.5 — Gestion du dépôt

Cette version corrige les chemins d’import des nouvelles fonctions
Cloudflare Pages et affiche le numéro `V10.5` à côté du nom BreizhStops.
...
## V10.5 — résolution des conducteurs
...
## V10.5 — Conducteur via rollup Notion
...
## V10.5 — synchronisation par lots
...
## V10.5 — synchronisation complète par lots
...
## V10.5 — Accueil et identité visuelle
...
## V10.5 — ajustements visuels ciblés
...
## V10.5 — visuels et filtrage définitif
...
## V10.5 — Prise de poste et statistiques
...
Exécuter dans la console D1 tout le bloc V10.5 présent à la fin de `schema.sql`,
...
## V10.5 — Activité et progressions
...
## V10.5 — correction de l'emplacement du chronotachygraphe
...
## V10.5 — correction Stationnement
...
## V10.5 — schéma final et détection des véhicules
...
## V10.5 — synchronisation Notion par lots
...
## V10.5 — optimisation Stationnement et Départs
...
## V10.5 — proportions PC, paysage iPhone et compteurs
...
## V10.5 — Stationnement et tâches du jour
...
## V10.5 — correction des vues Notion
...
## V10.5 — nom des conducteurs corrigé
...
## V10.5 — synchronisation publique et heures locales
...
## V10.5 — stationnement public et compteur d'heures fidèle
...
## V10.5 — opérations BreizhStops sans reconnexion Cloudflare
