...
## V8.1 — Gestion du dépôt

Cette version corrige les chemins d’import des nouvelles fonctions
Cloudflare Pages et affiche le numéro `V8.1` à côté du nom BreizhStops.
...
## V8.1 — résolution des conducteurs
...
## V8.1 — Conducteur via rollup Notion
...
## V8.1 — synchronisation complète par lots
...
## V8.1 — Accueil et identité visuelle
...
## V8.1 — ajustements visuels ciblés
...
## V8.1 — visuels et filtrage définitif
...
## V8.1 — Prise de poste et statistiques
...
Exécuter dans la console D1 tout le bloc V8.1 présent à la fin de `schema.sql`,
...
## V8.1 — correction de l'emplacement du chronotachygraphe
...
## V8.1 — schéma final et détection des véhicules
...
## V8.1 — synchronisation Notion par lots
...
## V8.1 — optimisation Stationnement et Départs
...
## V8.1 — proportions PC, paysage iPhone et compteurs
...
## V8.1 — Stationnement et tâches du jour
...
## V8.1 — correction des vues Notion
...
## V8.1 — nom des conducteurs corrigé
...
## V8.1 — synchronisation publique et heures locales
...
## V8.1 — stationnement public et compteur d'heures fidèle
